...
from Pyrochiy.helpers.misc import HAPP, XCB
from Pyrochiy.helpers.tools import get_arg
from Pyrochiy.utils.misc import restart
from Pyrochiy.utils.pastebin import PasteBin
from Pyrochiy.utils.tools import bash
...
async def upstream(client: Client, message: Message):
    ...
    if HEROKU_API_KEY is not None:
        ...
        if heroku_app is None:
            ...
            return
        await status.edit(
            "`[HEROKU]: Update Deploy Pyrochiy-Userbot Sedang Dalam Proses...`"
        )
        ups_rem.fetch(ac_br)
        ...
        try:
            ...
            pass
        await status.edit(
            "`Pyrochiy-Userbot Berhasil Diupdate! Userbot bisa di Gunakan Lagi.`"
        )
    else:
        try:
            ups_rem.pull(ac_br)
        ...
        args = [sys.executable, "-m", "Pyrochiy"]
...
add_command_help(
    "update",
    [
        ["update", "Untuk melihat list pembaruan terbaru dari Pyrochiy-Userbot."],
